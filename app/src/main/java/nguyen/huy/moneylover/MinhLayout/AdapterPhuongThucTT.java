...
public class AdapterPhuongThucTT extends ArrayAdapter<String> {

    Context context;
    int resource;
    List<String> objects;
    public AdapterPhuongThucTT(@NonNull Context context, int resource, @NonNull List<String> objects) {
