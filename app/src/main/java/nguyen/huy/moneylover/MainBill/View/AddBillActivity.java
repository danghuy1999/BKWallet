...
public class AddBillActivity extends AppCompatActivity {
    ...
    public static final int INTENT_ACTIVITY_SELECT_FORM = 2705;
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        Bitmap bitmap= GetImage.getBitmapFromString(AddBillActivity.this,namegroup);
    ...
    private void toProcessSave() {
        ...
        bill.setForm(editFormPay.getText().toString());
        arrBill.add(bill);
...
//            @Override
//            public void onClick(View v) {
//                Intent intent=new Intent(AddBillActivity.this,DialogRepeatActivity.class);
...
//        });
        ...
        editFormPay.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(AddBillActivity.this, PaymentFormActivity.class);
    ...
    private void toProcessOpenDateTime() {
        ...
        DatePickerDialog datePickerDialog=new DatePickerDialog(AddBillActivity.this,
                callback1,
    ...
    private void toProcessSelectGroup() {
        Intent intent=new Intent(AddBillActivity.this, SelectGroupActivity.class);
        intent.putExtra("CODE", 1);
    ...
    private void addControls() {
        ...
        imgIcForm=findViewById(R.id.imgIcForm);
        editFormPay=findViewById(R.id.editFormPay);
