...
public class ActivityDetailBill extends AppCompatActivity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(requestCode==INTENT_ACTIVITY_EDITBILL){
            if(resultCode== RESULT_OK){
                ...
                Bitmap bitmap= GetImage.getBitmapFromString(ActivityDetailBill.this,bill1.getGroup());
                imgIconBillDetail.setImageBitmap(bitmap);
                txtAmountBillDetail.setText(bill1.getAmount());
    ...
    private void toPrecessDelete() {
        ...
        builder.setPositiveButton("Có", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                ActivityDetailBill.this.finish();
            }
        });
    ...
    private void toPrecessEdit() {
        Intent intent=new Intent(ActivityDetailBill.this, ActivityEditBill.class);
    ...
    private void addControls() {
        ...
        Bitmap bitmap= GetImage.getBitmapFromString(ActivityDetailBill.this,bill.getGroup());
        imgIconBillDetail.setImageBitmap(bitmap);
