...
public class DialogRepeatActivity extends Activity {
    ...
    private void toProcessTimeAlarm() {
        ...
        TimePickerDialog timePickerDialog=new TimePickerDialog(DialogRepeatActivity.this,
                callback2,
    ...
    private void toPrecessOpenFirstDate() {
        ...
        DatePickerDialog datePickerDialog=new DatePickerDialog(DialogRepeatActivity.this,
                callback1,
                cal.get(cal.YEAR),
                cal.get(cal.MONTH),
