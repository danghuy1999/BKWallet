...
import nguyen.huy.moneylover.MainEvent.Adapter.AdapterSymbol;
import nguyen.huy.moneylover.R;

public class SymbolEventActivity extends AppCompatActivity {

    GridView gvHinh;
    public ArrayList<Integer>dsHinh;
    AdapterSymbol adapterBieuTuong;
    ...
    private void addEvents() {
        gvHinh.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(code==1)
                    intent.setClass(SymbolEventActivity.this, AddEventActivity.class);
                else if (code==2)
                    intent.setClass(SymbolEventActivity.this, EditEventActivity.class);
    ...
    private void addControls() {
        ...
        adapterBieuTuong=new AdapterSymbol(SymbolEventActivity.this,R.layout.truong_item_bieutuong,dsHinh);
